				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="page-heading">
							<h3 class="p-2">All Returned Receipts</h3>
						</div>
					</div> <!-- /panel-heading -->
					...
					<div class="panel-body">
						...
						<table class="table table-striped" id="returned_sales">
							<thead>
								<tr>
									<th>Order Date</th>
									<th>Cashier</th>
							...
							<tbody>
								...
								quantity,payment_type,customer_phone,return_date 
