                ...
                <div class="col-md-12">
                    <div class="panel panel-default" style="border:0px !important">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                            if (isset($status)) {
                                echo "<div class='alert alert-success'> Transfer have been processed successfully </div><br>";
                            }
                            ...
                            if (!empty($_GET["action"]) && $_GET["action"] == "clear_cart") {
                                ...
                                echo "<div class='alert alert-success'> <b>All Products cleared..You can now make new Transfers<b/> </div><br>";
                            }
                            ...
                            if (isset($_POST["submitNow"])) {
                                ...
                                if (empty($getLastID)) {
                                    $order_number = intval(date('yd')) + 1;
                                } else {
                                    $order_number = $getLastID + 1;
                                }

                                //get name of branch or store
                                $sql4 = mysqli_query($con, "SELECT * FROM stores WHERE store_id='$store'") or die(mysqli_error($con));
                                ...
                                <div id="print-holder2" style="margin-left:-45px;">
                                    ...
                                    <p style="font-size: 12px">
                                        ...
                                        if (!empty($getStoreName)) {
                                            echo "<br><b>Store:</b> <span>$getStoreName</span><br>";
                                        }
                                ...
                                <table class="table" style="margin-left:-45px;border:0px;font-size: 12px;font-family:'Times New Roman', Times, serif">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_SESSION["store_transfer_from"])) {
                                            $from_store_id = $_SESSION["store_transfer_from"];
                                        } else {
                                        ...
                                        foreach ($_SESSION["ttb_products"] as $product) {
                                            ...
                                            if (isset($_SESSION["store_transfer_from"])) {
                                                $store_id = $_SESSION["store_transfer_from"];

                                                //update stock transfer by substracting the quantity for the product being transferred
                                                $sql4 = mysqli_query($con, "UPDATE stock_transfer SET quantity_rem=quantity_rem-$product_qty WHERE store_id='$store_id' AND product_id='$product_number' ORDER BY id DESC");
                                            }

                                            ///DO NOT INSERT DATA
                                            $sql = mysqli_query($con, "INSERT INTO stock_transfer
                                (cashier,product_id,product_name,quantity,quantity_rem,transfer_date,transfer_time,invoice_number,store_name,store_id,from_store_id) 
                                VALUES('$user_id','$product_number','$product_name',$product_qty,$product_qty,'$today','$transfer_time','$order_number','$getStoreName','$store','$from_store_id')") or die(mysqli_error($con));
                        ...
                        ?>
                            <form method="post">
                                ...
                                <table class="table table-striped table-responsive" id="shopping-cart-results" style="font-family: 'Oxygen';font-size:14px">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control" name="store" id="store" required="">
                                                    ...
                                                    $current_store = $_SESSION["store_id"];

                                                    $sql1 = mysqli_query($con, "SELECT * FROM stores") or die(mysqli_error($con));
                                                    while ($row = mysqli_fetch_array($sql1)) {
                                                        //check if logged in user is from main store
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td><br><br><a href="multistore" class="btn btn-primary">
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <br>
                                                <a href="multistore_checkout?action=clear_cart" name="clearCart" id="clearCart" class="btn btn-warning btn-block">Clear All
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                                <br>
                                                <button type="submit" name="submitNow" id="submitNow" class="btn btn-success btn-block">Submit
