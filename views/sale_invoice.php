                ...
                <div class="panel panel-default" style="border:0px !important">
                    ...
                    <div class="panel-body">
                        ...
                        if (isset($_GET["invoiceno"])) {
                            ...
                            $query3 = mysqli_query($con, "SELECT * FROM sold_products WHERE invoice_number='" . $_GET['invoiceno'] . "'") or die(mysqli_error($con));
                        ...
                        ?>
                            ...
                            <div id="print-holder2">
                                ...
                                <p style="font-size: 12px">
                                    ...
                                    <br>
                                    <b>Date:</b> <?php echo $query3Data['order_date'] . " " . $query3Data['order_time'];  ?>
                                    <?php
                            ...
                            <table class="table" style="border:0px;font-size: 12px;font-family:'Times New Roman', Times, serif">
                                ...
                                <tbody>
                                    ...
                                    $querySales = mysqli_query($con, "SELECT * FROM sold_products WHERE invoice_number='" . $_GET['invoiceno'] . "'") or die(mysqli_error($con));
